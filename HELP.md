...
* The original package name 'com.github.igomarcelino.jwt-nimbus-jose' is invalid and this project uses 'com.github.igomarcelino.jwt_nimbus_jose' instead.
...
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/3.5.16/reference/web/spring-security.html#web.security.oauth2.server)
